        ...
        <div className="flex flex-col w-full">
          ...
          <div className="flex flex-col max-w-7xl">
            ...
            <div className="flex items-center justify-between p-4 mb-2 border rounded-lg">
              <div className="flex ">
                ...
                <div className="w-6 h-6 mx-1 bg-teal-400 rounded-full"></div>
                <span className="text-sm font-medium tracking-wider text-gray-400">
                  to wallet{" "}
                  <span className="hidden font-semibold text-teal-400 xl:inline-block text-md">
                    0xe4385b6b8a911Cdd07D21Fee56B3B4327A3caBf2
                  </span>
                  <span className="font-semibold text-teal-400 xl:hidden text-md">
                    0xe4385b6b811Cdd...
                  </span>
                </span>
              </div>
          ...
          <div className="sticky bottom-0 right-0 items-center w-full py-4 mt-4 bg-white border-gray-200 max-w-7xl sm:flex sm:justify-between">
            ...
            <div className="flex items-center space-x-3">
              <a
                href="#"
                className="inline-flex items-center justify-center flex-1 px-3 py-2 text-sm font-medium text-center text-white bg-teal-400 rounded-lg hover:bg-teal-500 focus:ring-4 focus:ring-cyan-200"
              >
