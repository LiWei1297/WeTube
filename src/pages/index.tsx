  ...
  return (
    <>
      ...
      <div className="relative w-screen h-screen text-white flex items-center justify-center bg-primary-color">
        <div
          id="bg-cover"
          className="absolute top-0 left-0 w-screen h-screen bg-primary-color"
        >
          <img
            className="w-full max-h-full overflow opacity-40"
            src="https://images.unsplash.com/photo-1484387436194-cf7cb70800ce?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1000&q=80"
          />
        </div>
